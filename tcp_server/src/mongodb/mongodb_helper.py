...
from ..utils.utils import check_docker_run

# Charge les variables d'environnement uniquement si vous êtes dans Docker
# Vérifie l'environnement et exécute load_dotenv() si dans Docker
check_docker_run()
